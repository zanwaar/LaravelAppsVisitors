            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    ...
                    <div class="d-flex justify-content-between mb-2">
                        <button wire:click.prevent="addNew" class="btn btn-info shadow-sm"><i class="fa fa-plus-circle mr-1"></i> Add New User</button>
                                ...
                                <tbody wire:loading.class="text-muted">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @else
                                            <img src="https://ui-avatars.com/api/?rounded=true&background=5F9DF7&color=fff&name={{$user->name}}" style="width: 50px;" class="img img-circle mr-1" alt="">
                                        ...
                                        <td>
                                            ...
                                            <select class="form-control" wire:change="changeRole({{ $user }}, $event.target.value)">
                                                ...
                                                <option value="operator" {{ ($user->roles[0]->name  === 'operator') ? 'selected' : '' }}>OPERATOR</option>
                                            </select>
