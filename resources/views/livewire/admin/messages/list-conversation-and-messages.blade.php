                            ...
                            <a href="#" wire:click.prevent="viewMessage( {{ $conversation->id }})">
                                ...
                                <div class="contacts-list-info">
                                    <span class="contacts-list-name text-dark">
                                        ...
                                        @endif
                                        <small class="float-right contacts-list-date text-muted">{{ !$conversation->messages->last() ? "" : $conversation->messages->last()->created_at->format('d/m/Y')}}</small>
                                    </span>
                                    <span class="contacts-list-msg text-secondary">{{ !$conversation->messages->last() ? "" : $conversation->messages->last()->body }}</span>
                                </div>
                                <!-- /.contacts-list-info -->
                            </a>
                        </li>
                ...
                <div class="card-footer">
                    <form wire:submit.prevent="sendMessage" action="#">
                        <div class="input-group">
                            <input wire:model.defer="body" type="text" name="message" placeholder="Type Message ..." class="form-control" style="width: 100%;">
