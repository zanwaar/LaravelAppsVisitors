<div>
    ...
    <section class="content">
        <div class="container-fluid pb-5">
                        ...
                        <div class="card-body box-profile">
                            <div class="text-center" x-data="{ imagePreview: '{{ auth()->user()->avatar_url }}' }">
                                <input wire:model="image" type="file" class="d-none" x-ref="image" x-on:change="
                                    ...
                                    " />
                                <img x-on:click="$refs.image.click()" class="profile-user-img" x-bind:src="imagePreview ? imagePreview : '/backend/dist/img/user4-128x128.jpg'" alt="User profile picture">
                            </div>
            ...
            <livewire:activity-log.get-id-activity-log />
            <!-- /.row -->
        </div><!-- /.container-fluid -->
    </section>
    <!-- /.content -->
